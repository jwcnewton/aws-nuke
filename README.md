...
![Build Status](https://github.com/jwcnewton/aws-nuke/workflows/Golang%20CI/badge.svg?branch=main)
[![license](https://img.shields.io/github/license/rebuy-de/aws-nuke.svg)](https://github.com/jwcnewton/aws-nuke/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/rebuy-de/aws-nuke.svg)](https://github.com/jwcnewton/aws-nuke/releases)
...
a Pull Request or to create an [Issue](https://github.com/jwcnewton/aws-nuke/issues/new).
...
[releases page](https://github.com/jwcnewton/aws-nuke/releases), but we also
...
[release](https://github.com/jwcnewton/aws-nuke/releases) from GitHub.

#### Example for Linux Intel/AMD

Download and extract
`$ wget -c https://github.com/jwcnewton/aws-nuke/releases/download/v2.16.0/aws-nuke-v2.16.0-linux-amd64.tar.gz -O - | sudo tar -xz -C $HOME/bin`
